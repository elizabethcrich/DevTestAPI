...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=(localdb)\\MSSQLLocalDB;Database=DevTest;Trusted_Connection=true;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Claim>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Claims__3214EC07FB6F1698");
            ...
            entity.HasOne(d => d.ExternalPerson).WithMany(p => p.Claims)
                .HasForeignKey(d => d.ExternalPersonId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Claims__External__4D94879B");

            entity.HasOne(d => d.Organization).WithMany(p => p.Claims)
                .HasForeignKey(d => d.OrganizationId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Claims__Organiza__4CA06362");
        });

        modelBuilder.Entity<ClaimFkcode>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__ClaimFKC__3214EC078D4D5998");
            ...
            entity.HasOne(d => d.ExternalClaim).WithMany(p => p.ClaimFkcodes)
                .HasForeignKey(d => d.ExternalClaimId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__ClaimFKCo__Exter__4AB81AF0");

            entity.HasOne(d => d.ExternalPerson).WithMany(p => p.ClaimFkcodes)
                .HasForeignKey(d => d.ExternalPersonId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__ClaimFKCo__Exter__49C3F6B7");

            entity.HasOne(d => d.Fkcode).WithMany(p => p.ClaimFkcodes)
                .HasForeignKey(d => d.FkcodeId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__ClaimFKCo__FKCod__4BAC3F29");

            entity.HasOne(d => d.Organization).WithMany(p => p.ClaimFkcodes)
                .HasForeignKey(d => d.OrganizationId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__ClaimFKCo__Organ__48CFD27E");
        });

        modelBuilder.Entity<Fkcode>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__FKCodes__3214EC07E426C0AA");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Organiza__3214EC07C4B6D88F");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Person__3214EC074B7FB72C");
            ...
            entity.HasOne(d => d.Organization).WithMany(p => p.People)
                .HasForeignKey(d => d.OrganizationId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Person__Organiza__4E88ABD4");
        });

        modelBuilder.Entity<PersonEmail>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__PersonEm__3214EC0775C167EB");
            ...
            entity.HasOne(d => d.ExternalPerson).WithMany(p => p.PersonEmails)
                .HasForeignKey(d => d.ExternalPersonId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__PersonEma__Exter__5070F446");

            entity.HasOne(d => d.Organization).WithMany(p => p.PersonEmails)
                .HasForeignKey(d => d.OrganizationId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__PersonEma__Organ__4F7CD00D");
        });

        modelBuilder.Entity<PersonPhone>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__PersonPh__3214EC0787BC9CF2");
            ...
            entity.HasOne(d => d.ExternalPerson).WithMany(p => p.PersonPhones)
                .HasForeignKey(d => d.ExternalPersonId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__PersonPho__Exter__52593CB8");

            entity.HasOne(d => d.Organization).WithMany(p => p.PersonPhones)
                .HasForeignKey(d => d.OrganizationId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__PersonPho__Organ__5165187F");
        });

        modelBuilder.Entity<PersonRelated>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__PersonRe__3214EC07DD069DBF");
            ...
            entity.HasOne(d => d.ExternalPerson).WithMany(p => p.PersonRelateds)
                .HasForeignKey(d => d.ExternalPersonId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__PersonRel__Exter__5441852A");

            entity.HasOne(d => d.Organization).WithMany(p => p.PersonRelateds)
                .HasForeignKey(d => d.OrganizationId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__PersonRel__Organ__534D60F1");
        });
